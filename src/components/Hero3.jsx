        ...
        <div className='flex flex-col items-center justify-between lg:flex-row'>
          <div className=' '>
            ...
            <div className='mt-10 flex flex-col items-center md:flex-row'>
              <a
                href='/'
                className='focus:shadow-outline mb-3 inline-flex h-12 w-full items-center justify-center rounded bg-blue-700 px-6 font-medium tracking-wide text-white shadow-md transition hover:bg-blue-800 focus:outline-none md:mr-4 md:mb-0 md:w-auto'
              >
                Stream Now{' '}
              </a>
              <a
