...
const Booking = () => {
  return (
    <div className='w-screen'>
      <div className='relative mx-auto mt-20 mb-20 max-w-screen-lg overflow-hidden rounded-t-xl bg-orange-400/60 py-32 text-center shadow-xl shadow-gray-300'>
        <h1 className='mt-2 px-8 text-3xl font-bold text-white md:text-5xl'>
          Book an appointment
        </h1>
        <p className='mt-6 text-lg text-white'>Book a birthday party today!</p>
        <img
          className='absolute top-0 left-0 opacity-10 h-full w-full object-cover'
          src={splashPhoto1}
          alt=''
        />
      </div>
      ...
      <div className='mx-auto grid max-w-screen-lg px-6 pb-20'>
        <div className=''>
          <p className='font-serif text-xl font-bold'>Select a Service</p>
