...
const Footer2 = () => {
  return (
    // <footer className="mx-auto p-4 md:p-8 lg:p-10 bg-gray-50">
    //   <div className="grid gap-y-8 gap-x-0 px-0 py-10 md:grid-cols-2 xl:grid-cols-4 xl:px-10">
      ...
      <div className="mx-auto max-w-screen-xl text-center">
        ...
        <nav>
          <ul className="flex flex-wrap justify-center items-center mb-6 text-gray-500">
            ...
            <li>
              <NavLink to="/booking" className="mr-4 hover:underline md:mr-6">
                Booking
              </NavLink>
            </li>
            <li>
              <NavLink to="/gallery" className="mr-4 hover:underline md:mr-6 ">
                Gallery
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/waiver" className="mr-4 hover:underline md:mr-6">
                Waivers
              </NavLink>
            </li>
            <li>
            ...
            <li>
              <NavLink to="/contact" className="mr-4 hover:underline md:mr-6">
                Contact
              </NavLink>
            </li>
          </ul>
